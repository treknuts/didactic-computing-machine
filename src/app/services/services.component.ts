...
export class ServicesComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    let service2 = new Service("App", "Bring your app idea to life, and put it into the hands of users on all devices", "https://plus.unsplash.com/premium_photo-1664368832503-7d9a4ccf25af?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8N3x8cGhvbmV8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60");
